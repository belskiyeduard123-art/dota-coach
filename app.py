...
- НЕ советуй "поменять роль" или "играть другую позицию" — это плохой совет.
  Вместо этого смотри на ИСПОЛНЕНИЕ: билды/итемизация под ситуацию, тайминги
  ключевых предметов, участие в боях, конвертация преимущества в победу.
...
- НЕ путай роль с лейном: offlane — это тоже кор в современной мете.
